    ...
    <div class="bradcam_area" style="background: #da2d2d;">
        <h3>Pilihan Paket IndiHome Fiber</h3>
    </div>
    <!-- bradcam_area_end -->
    ...
    <div class="package_prsing_area">
      <div class="container">
        ...
        <div class="row package-list" for="streamix" id="streamix">
          <div class="col-xl-3 col-md-6 col-lg-3">
            <div class="single_prising">
        ...
        <div class="row package-list" for="gamer" id="gamer">
          <div class="col-xl-4 col-md-6 col-lg-4">
            <div class="single_prising">
            ...
            <div class="single_border">
              <div class="row align-items-center">
                <div class="col-xl-6 col-md-4 col-lg-6">
                  <h3>Punya Pertanyaan Tentang IndiHome?</h3>
                </div>
