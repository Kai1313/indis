<?php
	...
	class Home extends CI_Controller {
		...
		public function index() {
			$data['title']='Indihome Sidoarjo';
			$data['content']='menus/home';
			$this->load->view('layouts/wrapper',$data);	
		}

		public function hargaPaket() {
			$data['title']='Indihome Sidoarjo';
			$data['content']='menus/package';
			$this->load->view('layouts/wrapper',$data);	
		}

		public function kontak() {
			$data['title']='Indihome Sidoarjo';
			$data['content']='menus/contact';
			$this->load->view('layouts/wrapper',$data);	
		}

		public function tentangKami() {
			$data['title']='Indihome Sidoarjo';
			$data['content']='menus/about';
			$this->load->view('layouts/wrapper',$data);	
		}

		public function artikel() {
			$data['title']='Indihome Sidoarjo';
			$data['content']='menus/article';
			$this->load->view('layouts/wrapper',$data);	
		}

		public function artikelDetailA() {
			$data['title']='Indihome Sidoarjo';
			$data['content']='menus/article-detail';
			$this->load->view('layouts/wrapper',$data);	
		}

		public function artikelDetailB() {
			$data['title']='Indihome Sidoarjo';
			$data['content']='menus/article-detail-2';
			$this->load->view('layouts/wrapper',$data);	
		}
